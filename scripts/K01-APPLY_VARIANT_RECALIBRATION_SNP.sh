...
START_APPLY_RECALIBRATION_SNP=`date '+%s'`
	...
	# construct command line
		...
		CMD=$CMD" --analysis_type ApplyRecalibration" \
			...
			CMD=$CMD" --recal_file $CORE_PATH/$PROJECT/$FAMILY/VCF/CONTROLS_PLUS_$FAMILY".HC.SNV.recal"" \
			CMD=$CMD" --tranches_file $CORE_PATH/$PROJECT/$FAMILY/VCF/CONTROLS_PLUS_$FAMILY".HC.SNV.tranches"" \
