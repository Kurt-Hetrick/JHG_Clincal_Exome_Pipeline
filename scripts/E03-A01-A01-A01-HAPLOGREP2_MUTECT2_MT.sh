...
START_HAPLOGREP2_MUTECT2_MT=`date '+%s'` # capture time process starts for wall clock tracking purposes.
	...
	# construct command line
		...
		CMD=$CMD" /jars/haplogrep-2.1.20.jar"
			CMD=$CMD" --in ${CORE_PATH}/${PROJECT}/${FAMILY}/${FAMILY}_EMEDGENE/${SM_TAG}.MUTECT2_MT_FILTERED_MASKED.vcf"
...
# write out timing metrics to file
	...
	echo ${SM_TAG}_${PROJECT},H01,HAPLOGREP2_MUTECT2_MT,${HOSTNAME},${START_HAPLOGREP2_MUTECT2_MT},${END_HAPLOGREP2_MUTECT2_MT} \
