...
echo $FAMILY"_"$PROJECT",V.01,VARIANT_TO_TABLE_TABIX_"$FAMILY"_ALL_SITES,"$HOSTNAME","$START_VARIANT_TO_TABLE_TABIX_FAMILY","$END_VARIANT_TO_TABLE_TABIX_FAMILY \
...
md5sum $CORE_PATH/$PROJECT/$FAMILY/VCF/$FAMILY".VQSR.ANNOTATED.JUST_FAMILY.txt.gz.tbi" \
