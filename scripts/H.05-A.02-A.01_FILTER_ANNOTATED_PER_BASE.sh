...
# uncommitted to this being a variable, but it can change
	...
	awk 'NR>1' $CORE_PATH/$PROJECT/$FAMILY/$SM_TAG/REPORTS/DEPTH_OF_COVERAGE/CODING_PADDED/$SM_TAG"_"$CODING_BED_NAME"-"$CODING_MD5"-"$PADDING_LENGTH"-BP-PAD.PER.BASE.REPORT.txt" | awk '$7<30' ) \
