	...
	# construct command line
		...
		CMD="singularity exec $MITO_MUTECT2_CONTAINER bcftools"
			CMD=$CMD" roh"
				...
				CMD=$CMD" $CORE_PATH/$PROJECT/TEMP/VCF_PREP/CONTROLS_PLUS_${FAMILY}.VQSR.ANNOTATED.SNV_ONLY.PASS.BIALLELIC.REPEATMASK.vcf.gz"
				CMD=$CMD" --output $CORE_PATH/$PROJECT/$FAMILY/ROH/CONTROLS_PLUS_${FAMILY}.ROH_REGIONS.txt"
...
# write out timing metrics to file
	...
	echo ${FAMILY}_${PROJECT},S.01,ROH,${HOSTNAME},${START_ROH},${END_ROH} \
