...
START_VARIANT_RECALIBRATOR_INDEL=`date '+%s'`
	...
	# construct command line
		...
		CMD=${CMD}" --rscript_file ${CORE_PATH}/${PROJECT}/${FAMILY}/VCF/VQSR/CONTROLS_PLUS_${FAMILY}.HC.INDEL.R"
...
# write out timing metrics to file
	...
	echo ${FAMILY}_${PROJECT},H01,VARIANT_RECALIBRATOR_INDEL,${HOSTNAME},${START_VARIANT_RECALIBRATOR_INDEL},${END_VARIANT_RECALIBRATOR_INDEL} \
