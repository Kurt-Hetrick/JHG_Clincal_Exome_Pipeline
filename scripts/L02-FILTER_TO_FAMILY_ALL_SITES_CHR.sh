...
START_FILTER_TO_FAMILY_ALL_SITES=`date '+%s'`
	...
	# construct command line
		...
		CMD=${CMD}" SelectVariants"
			...
			CMD=${CMD}" --sample-name ${CORE_PATH}/${PROJECT}/${FAMILY}/${FAMILY}.sample.args"
		CMD=${CMD}" --output ${CORE_PATH}/${PROJECT}/TEMP/${FAMILY}.VQSR.ANNOTATED.JUST_FAMILY.${CHROMOSOME}.vcf"
...
# write out timing metrics to file
	...
	echo ${FAMILY}_${PROJECT},L01,FILTER_TO_FAMILY_ALL_SITES_${CHROMOSOME},${HOSTNAME},${START_FILTER_TO_FAMILY_ALL_SITES},${END_FILTER_TO_FAMILY_ALL_SITES} \
