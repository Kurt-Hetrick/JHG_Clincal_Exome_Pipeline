...
# write out timing metrics to file
	...
	echo ${FAMILY}_${PROJECT},S.01,FILTER_TO_FAMILY_TARGET_VARIANT_ONLY,${HOSTNAME},${START_FILTER_TO_FAMILY_TARGET_VARIANT_ONLY},${END_FILTER_TO_FAMILY_TARGET_VARIANT_ONLY} \
