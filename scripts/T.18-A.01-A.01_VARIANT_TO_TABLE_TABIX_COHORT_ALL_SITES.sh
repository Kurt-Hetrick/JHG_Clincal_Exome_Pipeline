...
echo $FAMILY"_"$PROJECT",V.01,VARIANT_TO_TABLE_CONTROLS_PLUS_"$FAMILY"_ALL_SITES,"$HOSTNAME","$START_VARIANT_TO_TABLE_TABIX_COHORT","$START_VARIANT_TO_TABLE_TABIX_COHORT \
...
md5sum $CORE_PATH/$PROJECT/$FAMILY/VCF/CONTROLS_PLUS_$FAMILY".VQSR.ANNOTATED.txt.gz.tbi" \
